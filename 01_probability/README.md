...
| 08 经典专题 | ★★★★★ | 中→高 | 生日/Monty Hall/赌徒破产 |
| 09 题卡 | — | — | 考前 2 小时刷 |
...
- [08_经典概率题专题.md](08_经典概率题专题.md) —— 10 道高频原题精讲
- [09_面试题卡.md](09_面试题卡.md) —— 40 题分组刷 + 考前检查清单

## 配图（assets/）

连续/离散分布对比、CLT 收敛、贝叶斯树、次序统计量、赌徒破产——可用 `make_figures.py` 重新生成。
